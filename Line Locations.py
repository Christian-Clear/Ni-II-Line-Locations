...
try: 
    ...
    for i, row in enumerate(reader):
        ...
        t = plt.text(lower+width*1.01, height+0.01, row[0], color='black', size='large')
        ...
        box = ptch.Rectangle((lower,0), width, height, fc='CornflowerBlue', ec='blue', zorder=2, alpha=0.4)
...
p = ptch.Rectangle((0, 0), 1, 1, fc="CornflowerBlue")
...
plt.legend([p], ["Ni II (3F), log(gf) > -1.0 "])
